export function About() {
    return (
        <section id="about" className="flex flex-col gap-4 relative z-10 px-5 py-3 md:py-5 md:grid md:grid-cols-2 md:grid-rows-1">
            <div className="w-full h-64 md:h-full">
                <img src="/me_picture.JPG" className="shadow-md shadow-purple-500/50 rounded-2xl w-full h-full object-cover" alt="Gian Raphael" />
            </div>
